    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("Admin.Product", t => t.ProductId, cascadeDelete: true)
                .Index(t => t.ProductId);
        ...
        {
            DropForeignKey("dbo.OrderDetail", "Productid", "Admin.Product");
            DropForeignKey("dbo.OrderDetail", "Orderid", "dbo.Order");
            DropForeignKey("dbo.Cart", "ProductId", "Admin.Product");
